...
go
-----------------------------------------------------------------------
ALTER PROCEDURE [dbo].[ADC_BALANCE_SIT]
 (
...
go
--------------------------------------------------------------------------------------
 ALTER PROCEDURE [dbo].[ACTNOV_INS_MOV]
    (@Opcion CHAR(1)='',
    @Doc_sucursal char(3)='',
	...
	@NVvalorresidual numeric(18,2)=0,
	@NVvidautil numeric(18,2)=0,
	@NVdeterioro numeric(18,2)=0,
	@NVrevalorizacion numeric(18,2)=0,
	@NVvalorproduccionmes numeric(18,2)=0
		)
AS
BEGIN         
	IF @Opcion ='I'
	...
	ELSE 
		...
		SET
			...
			NVvalorresidual=@NVvalorresidual,
			NVvidautil=@NVvidautil,
			NVdeterioro=@NVdeterioro,
			NVrevalorizacion=@NVrevalorizacion,
			NVvalorproduccionmes =@NVvalorproduccionmes
...
-----------------------------------------------------------------------------------------
ALTER PROCEDURE [dbo].[ACTNOV_ELM_MOV]
    (@Opcion CHAR(1)='',
    @Doc_sucursal char(3)='',
	@Opc_documento char(3)='',
	@Doc_numero numeric (18,0)=0,
...
BEGIN         
	...
	where Codigo = @Codigo and Opc_documento =@Opc_documento and 
		...
		NVvalorresidual=@NVvalorresidual and NVvidautil=@NVvidautil and
		NVdeterioro=@NVdeterioro and NVrevalorizacion=@NVrevalorizacion and
		NVvalorproduccionmes=@NVvalorproduccionmes and
