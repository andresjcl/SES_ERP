...
namespace DctosEmi
{
    class CopiarDocumento
    {
        public void CopiarElDocumento(idDocumento IdDocOrigen,string tablaOrg, ref ClassDoc.AdcDoc DocDestino, ref DataTable dtTransacc,bool CopyTransacc=true)
        {
            ...
            // ✅ LIMPIAR CAMPOS SRI (NUEVO)
            LimpiarDatosSri(ref DocDestino);
        ...
        private void LimpiarDatosSri(ref ClassDoc.AdcDoc doc)
        {
            doc.claveSri = null;              // o ""
            doc.estadoSri = "";                // o "" según tipo
            doc.NroAutorizacionSri = null;    // o ""
            doc.fechaAutorizacion = null;     // o DateTime.MinValue
            doc.tipoEmision = 0;           // o ""
        }
