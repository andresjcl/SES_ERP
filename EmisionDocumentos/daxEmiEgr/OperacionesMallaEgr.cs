...
namespace DctosEmi
{
    public class OperacionesMallaEgr
    {
        public void DocumentosEscojidosAcoleccion(DataGridView malla, DocPendientes.ListDocAplican listaDocumentos, string CodConcepto)
        {
        ...
        public void DocumentosEscojidosDeColeccionAmalla(DataGridView malla, DocPendientes.ListDocAplican listaDocumentos, string CodConcepto)
        {
        ...
        public void DocumentosEscojidosDeColeccionAmalla(DataGridView malla, DocPendientes.ListDocAplican listaDocumentos)
        {
            if (listaDocumentos.ListaDocAplican.Count == 0) return;
            malla.Columns.Clear ();
            malla.Rows.Clear();

            malla.Columns.Add("nombreImpresion", "Nombre");
            malla.Columns.Add("Apl_docapli", "DOC");
            malla.Columns.Add("Apl_Valorapl", "Valor");
            malla.Columns.Add("Apl_numapli", "Numero");
            malla.Columns.Add ("IdClaveDocApl","");
            malla.Columns.Add("Apl_codbenef","");
            malla.Columns.Add("Apl_docfecha","");
            malla.Columns.Add("Apl_sucapli", "");

            malla.Columns["nombreImpresion"].Width = 250;
            malla.Columns["Apl_docapli"].Width = 25;
            malla.Columns["Apl_numapli"].Width = 90;
            malla.Columns["Apl_Valorapl"].Width = 90;
            malla.Columns["IdClaveDocApl"].Visible = false;
            malla.Columns["Apl_codbenef"].Visible = false;
            malla.Columns["Apl_docfecha"].Visible = false;
            malla.Columns["Apl_sucapli"].Visible = false;


            foreach (DocPendientes.DocAplica docapl in listaDocumentos.ListaDocAplican)
            {
                malla.Rows.Add();
                DataGridViewRow newrow = malla.Rows[malla.Rows.Count -1];
//                newrow.Cells["CodConcepto"].Value = CodConcepto;
                newrow.Cells["IdClaveDocApl"].Value = docapl.IdClaveDoc;
                newrow.Cells["Apl_codbenef"].Value = docapl.CodigoCliente;
                newrow.Cells["Apl_docfecha"].Value = docapl.fechaDocumento;
        ...
        public void ClasificadoresEscojidosAcoleccion(DataGridView malla, ClasificadoresMallas  listaClasificadores, string CodConcepto,string CampoTra)
        {
        ...
        public void ClasificadoresEscojidosDeColeccionAmalla(DataGridView malla, ClasificadoresMallas listaClasificadores, string CodConcepto, string CampoTra)
        {
        ...
        internal void DiseñarMallaEgresoBancos(DataGridView malla, sesSys.OpcDoc propiedadesDocmto, daxAccs.propiedadesDaxAuto accesosLocalizados = null)
        {
