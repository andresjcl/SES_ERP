...
namespace DctosEmi
{
	public partial class FormFactProveedor : Form
	{
		...
		string memVendedor = "";
		string memBodega = "";
		public FormFactProveedor(string clasdef, string tipdef, bool nuevo = false, Boolean esConsulta = false, Boolean generarFactura = false, Boolean desdeEstdoCta = false, idDocumento idDocViene = null, string sisMedico = "")
		{
			InitializeComponent();
		...
		private Boolean grabarDocumento()
		{
            ...
            else
            {
				if (txtCodigoRet.Text!="332" && txtCodigoRet.TextLength ==0)
				{
					...
					{
						IvaRett.MantRetencion prog = new IvaRett.MantRetencion(1, idDocumentoActual, false);
						prog.ShowDialog();
						prog.Dispose();
					}
				}
