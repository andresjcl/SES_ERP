...
namespace adcDocumentos
{
	...
	{
		public void PrecioUnitario(Keys keyData, DataGridView malla, adcArticulo.AdcArt propiedadesArt, TablasSRI.docImpuestos claseImpuestos, int nroDigitosEnPrecios)
		{
			...
			int quePrecio = 0;
			cell.Value = adcArticulosPrecios.cargarPrecios.CargarPrecioVta(Convert.ToInt32(keyData), ref propiedadesArt, claseImpuestos.impstoPorcentaje1, ref quePrecio, "", row.Cells["tra_Medida"].Value.ToString(), "", nroDigitosEnPrecios);
			...
			//		dato = buscserv.iniciaBuscador(varbleComun.VarCom.strConxAdcom, "", "CC", false, true);
