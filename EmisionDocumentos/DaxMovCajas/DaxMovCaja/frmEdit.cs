...
namespace DaxMovCaja
{
    public partial class frmEdit : Form
    {
        public frmEdit()
        {
            ...
            llcbo.DaxCombosPtoVtaReg(datosEmpresa.strConxAdcom, ref cboPtoVenta,true,datosEmpresa.suc);
        }
        string tit1 = "";
        string tit2 = "";
        ...
        private void ImprimirToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            preparaTitulo();
            imp.imprimir(Malla, tit1, tit2, datosEmpresa.nomEmpresa);
        }
        ...
        private void ejecutarConsulta()
        {
            ...
            {
                ConnectionString = datosEmpresa.strConxAdcom
            };
            conexion.Open();
