...
namespace adcDocumentos
{
    ...
    {
        public double nroDeDocumento( string laTabla,string reglaDuplicacion, Boolean autoNumeracion, double numeroDoc, string strDax,string suc,string tipoDoc,string nroDoc, string bod,string codper,string nroIdDoc)  // regresa el numero del documento 
        {
