...
#Region "METODOS"
    ...
    Private Sub loadWebServiceSRI()
        ...
        If wsAutorizacionValue.Count <= 0 Or wsRecepcionValue.Count <= 0 Then
            ...
            wsAutValue.Add(1, "https://celcer.sri.gob.ec/comprobantes-electronicos-ws/AutorizacionComprobantesOffline?wsdl")
            wsRecValue.Add(1, "https://celcer.sri.gob.ec/comprobantes-electronicos_ws/RecepcionComprobantesOffline?wsdl")
            '----------------------------------------------------------------------
            wsAutValue.Add(2, "https://cel.sri.gob.ec/comprobantes-electronicos-ws/AutorizacionComprobantesOffline?wsdl")
            wsRecValue.Add(2, "https://cel.sri.gob.ec/comprobantes-electronicos-ws/RecepcionComprobantesOffline?wsdl")
