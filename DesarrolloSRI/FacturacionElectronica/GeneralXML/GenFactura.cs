...
namespace sesDocElectronicos
{
    public class GenFactura
    {
        ...
        public string crear_factura_xml_sri(ref DataRow doc,ref DataTable dtra, string pathfile,string clv, Int16 ambiente,Int16 tipoEmision,Int16 decimales,string NombreEmpresa, string NombreEmpresaComercial, string rucEmpresa, string DireccionEmpresa,string nombreBaseDatosIvaret,string strConxAdcom )
