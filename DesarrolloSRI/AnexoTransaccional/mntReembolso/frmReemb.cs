...
{
     public partial class frmReemb : Form
    {
        ...
        private void frmReemb_Load(object sender, EventArgs e)
        {
        ...
        private Boolean funcionesEspeciales(ref Keys keyData, ref DataGridViewCell cell)
        {
            ...
            if (keyData == Keys.F2)
            {
                ...
                {
                   DaxMantDirectorio.BuscaClien busProv = new DaxMantDirectorio.BuscaClien();
                    string clioProv ="P";
                    string nombre = "";
                    string conAlias="N";
                    string conNuevo="N";
        ...
        {
            DaxMantDirectorio.DirectorioAlex dalex = new DaxMantDirectorio.DirectorioAlex();
            bool  clioProv = false;
            string soloCodigo = "";
        ...
        public Boolean grabarReembolsos()
        {
            ...
            if (revisarMalla())
            {
                ...
                catch (Exception ee) { grabado = false; MessageBox.Show(ee.Message); return false; }
            }
