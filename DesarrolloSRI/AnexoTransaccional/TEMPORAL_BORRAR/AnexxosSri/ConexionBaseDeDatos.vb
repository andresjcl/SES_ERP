...
Module ConexionBaseDeDatos
	...
	Public Function ArmStr(ByRef Path As String, Optional ByRef Serv As String = "", Optional ByRef Tipo As String = "", Optional ByRef Passw As String = "", Optional ByRef Usuario As String = "", Optional ByRef Version As Short = 0) As Object
		Dim Clave As String
		Dim User As String
		If Tipo = "ACC" Then
