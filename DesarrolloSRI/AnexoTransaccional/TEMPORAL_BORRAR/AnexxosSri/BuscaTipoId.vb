...
Friend Class BuscaTipoId
	...
	Public Sub BuscaDoc(ByVal TipoTran As Short, ByRef QUECODIGO As String, ByRef QueNombre As String)
		Dim Reten As Object
		Dim Aux As String
	...
	Private Sub BuscaTipoId_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		Dim i As Object
		Dim Sw As Boolean
		...
		'
		'If Sw = False Then MsgBox "Las tablas del SRI no estan definidas correctamente", vbCritical: Exit Sub
		'
		...
		sSQL = "Select codigo, descripcion From SriTiposDeIdentificacion "
		'    Else
		'        ssql = "Select codigo, descripcion From SriSecuencialesTransacciones where CodigoTipoTransaccion = " & TipoTransaccion
		'    End If
	...
	'UPGRADE_WARNING: El evento BuscaTipoId.Resize se puede desencadenar cuando se inicializa el formulario. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub BuscaTipoId_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
	...
	Private Sub BuscaTipoId_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
