Option Strict Off
Option Explicit On
Friend Class BuscaRetIvaBienes
	...
	Private Sub BuscaRetIvaBienes_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		Dim i As Object
		Dim Sw As Boolean
		...
		Sw = True
		Ssql = "Select * From SriPorcentajesRetencionIvaBienes "
	...
	'UPGRADE_WARNING: El evento BuscaRetIvaBienes.Resize se puede desencadenar cuando se inicializa el formulario. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub BuscaRetIvaBienes_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
