...
namespace DctosEmi
{
    public class armarConsTra
    {
        ...
        public string armarSqlLecturaTraFacPv(sesSys.OpcDoc propedadesDocmto, string TablaTra, string suc, string tip, double idClave)
        {
            ...
            ssqlTra += ",Tra_prectot";
            ssqlTra += ",Tra_porceniva";
            ssqlTra += ",Tra_valoriva";
            ssqlTra += ",TRA_SNIVA";
            ssqlTra += ",tra_producto as COMP " ;
            ...
            ssqlTra += ",TRA_SNIVA";
            ssqlTra += ",AuxVar3";
            ssqlTra += ", case when isnull(AuxNum1,0) > 0 then cast(1 as bit) else cast(0 as bit ) end as CORT "; //cortesias
            ssqlTra += ", AuxNum1";
        ...
        public string armarSqlLecturaRemision(sesSys.OpcDoc propedadesDocmto, string TablaTra, string suc, string tip, double idClave)
        {
            string ssqlTra = "select ";
            ssqlTra += "TRA_NUMLINEA";
            ssqlTra += ",tra_codigo";
...
//            ssqlTra += ",tra_costuni";
  //          ssqlTra += ",Tra_CostTot";
      ...
      //      ssqlTra += ",tra_numprecio";
        ...
        public string armarSqlLecturaTransferencia(sesSys.OpcDoc propedadesDocmto, string TablaTra, string suc, string tip, double idClave)
        {
            string ssqlTra = "select ";
            ssqlTra += "TRA_NUMLINEA";
            ssqlTra += ",tra_codigo";
            ...
            ssqlTra += ",tra_numprecio";
            ssqlTra += ",0.0000 as Existencia ";
            ssqlTra += ",0.0000 as Enviado";
            ssqlTra += ",0.0000 as Diferencia";
            //	ssqlTra += ",0.0000 as precioArticulo";
            //    ssqlTra += ",'' as medidaArticulo";
        ...
        public string armarSqlLecturaMovPrep(sesSys.OpcDoc propedadesDocmto, string TablaDia, string suc, string tip, double idClave)
		{
			string ssqlTra = "select ";
