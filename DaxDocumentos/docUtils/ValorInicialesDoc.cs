...
namespace DctosEmi
{
    public static class valoresPredefinidosEmpresa
    {
        ...
        static public void cargaValores()
        {
            ...
            dt = datosEmpresa.leeParametrosEmp("Emp_PathImagenes,par_DigitosPrecios,par_DigitosCostos,Par_PagoCompras,par_CruceDocSucursal,Par_AcfNumNiv,Par_roltur");
            if (dt.Rows.Count > 0)
            {
                ...
                formaPagoPredefinidaVtas = dt.Rows[0]["Par_PagoCompras"].ToString();
