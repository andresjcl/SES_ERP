...
namespace documentosPdf
{
    public class generacionPdf
    {
        ...
        string PathServer = "";
        PrySysp13.OpcDoc opDoc;
        GenDatos GenDato;
        Int32 codEmpresa = 0;
        iTextSharp.text.Document docmtoPdf;        
        ...
        public string GeneraDocPdf( ClassDoc.idDocumento idDoc, string nombreDocumento = "", string QueSystema = "", string formatoImprime="", string AuxManual = "")
        {
            ...
            opDoc = new PrySysp13.OpcDoc();
            opDoc.Cargar(ref idDoc.Tipo, ref idDoc.Sucursal);
            ...
            else ImpText = new string[0];
           
            iTextSharp.text.Document docmtoPdf = new iTextSharp.text.Document(new iTextSharp.text.Rectangle(Anchoimprimible, Largoimprimible));
            ...
            FileStream fileStr = new FileStream(nombreDocumento, System.IO.FileMode.CreateNew);
            iTextSharp.text.pdf.PdfWriter grabadorPdf = iTextSharp.text.pdf.PdfWriter.GetInstance(docmtoPdf, fileStr);
            ...
            // grabadorPdf = PdfWriter.GetInstance(docmtoPdf, file); 

            grabadorPdf.AddViewerPreference(iTextSharp.text.pdf.PdfName.PICKTRAYBYPDFSIZE, iTextSharp.text.pdf.PdfBoolean.PDFTRUE);
            iTextSharp.text.pdf.PdfContentByte  contenedorPdf = new iTextSharp.text.pdf.PdfContentByte(grabadorPdf);
            docmtoPdf.Open();
            ...
            for (int nroPagina = 0; nroPagina < paginaActual; nroPagina++)
            {
                ...
                iTextSharp.text.pdf.BaseFont Ffont = iTextSharp.text.FontFactory.GetFont(iTextSharp.text.FontFactory.HELVETICA, campForma.FontSize).BaseFont;
                        ...
                        if (campForma.FHeight != 0)
                        {
                            if (campForma.FontNombre != "0" && fontAnt != campForma.FontNombre)
                            {
                                try
                                {
                                    ...
                                    iTextSharp.text.Font fuenteArial = new iTextSharp.text.Font(iTextSharp.text.pdf.BaseFont.CreateFont("c:/windows/fonts/" + nombreFont + ".ttf", iTextSharp.text.pdf.BaseFont.WINANSI, iTextSharp.text.pdf.BaseFont.EMBEDDED), campForma.FontSize);
                                    Ffont = fuenteArial.BaseFont;
                                }
                                catch
                                {
                                    Ffont = iTextSharp.text.FontFactory.GetFont(iTextSharp.text.FontFactory.HELVETICA, campForma.FontSize).BaseFont;
                                }
        ...
        private void manejarDatosBases(int nroPagina,string Campo, Int32 Alineacion, string FORMATO, Int32 Ancho, Int32 Posicion, iTextSharp.text.pdf.PdfContentByte cb, Int32 alto , iTextSharp.text.pdf.BaseFont fuente)
        {
        ...
        private void ImprimeLinea(Int32 PuntoX1, Int32 PuntoY1, Int32 PuntoX2, Int32 PuntoY2, Int32 AnchoLinea, iTextSharp.text.pdf.PdfContentByte cb)
        {            
        ...
        private void ImprimeCuadrado(Int32 PuntoX, Int32 PuntoY, Int32 AnchoCuadrado, Int32 AltoCuadrado,Int32 AnchoLinea, iTextSharp.text.pdf.PdfContentByte cb)
        {
            cb.SetLineWidth(Convert.ToInt64 (AnchoLinea));
            cb.Rectangle(PuntoX, Largoimprimible - PuntoY - AltoCuadrado , AnchoCuadrado, AltoCuadrado);
            cb.Stroke();
        }
        private void ImprimeImagen(string nomImagen, Int32 PuntoX, Int32 PuntoY, Int32 AnchoImagen, Int32 AltoImagen, iTextSharp.text.pdf.PdfContentByte cb)
        {
            try
            {
        ...
        public void ImprimeDato(string Campo, Int32 Alineacion, string FORMATO, Int32 Ancho, Int32 Posicion, iTextSharp.text.pdf.PdfContentByte contenedorPdf, Int32 alto, iTextSharp.text.pdf.BaseFont fuente)
        {
            ...
            if (tieneBarras )
            {
              libreriasTekform. codBarras.registraBarras(Aimprimir, FORMATO, Ancho, alto, Currenty, Posicion, Largoimprimible,ref docmtoPdf);                
            }
            else if (Aimprimir.Length != 0)
            {
                ...
                iTextSharp.text.Paragraph parrafo = new iTextSharp.text.Paragraph( 0,Aimprimir, fff);
                ...
                iTextSharp.text.pdf.ColumnText colum = new iTextSharp.text.pdf.ColumnText(contenedorPdf);
        ...
        public void ImprimeEtiqueta(string Aimprimir, Int32 Posicion, iTextSharp.text.pdf.PdfContentByte contenedorPdf, iTextSharp.text.pdf.BaseFont fuente)
        {            

                contenedorPdf.SetFontAndSize(fuente , campForma.FontSize);
                contenedorPdf.BeginText();
                contenedorPdf.ShowTextAligned(iTextSharp.text.pdf.PdfContentByte.ALIGN_LEFT, Aimprimir, campForma.FLeft, Largoimprimible - (Currenty + campForma.FHeight-2), 0); //, Largoimprimible - Currenty);
        ...
        private string DatoGeneral( string dato) 
        {
            ...
            if( datNum < 9821 && datNum > 9800 && ImpText.Length > 0) return  ImpText[datNum - 9801];
            return "";
        }
