...
namespace DaxCombobx
{
    public class CargCmbBox
    {
        ...
        public bool DaxCombosSuc(string empresa, bool todo, string StrCon, ref ComboBox PasCombo, bool userSuc = true)
        {
            ...
            if (!(SysEmpDatt.DatosUsuario.SucsUsr()  == null))
                condicion = SysEmpDatt.DatosUsuario.SucsUsr().Replace(" ", "','");
            else
                condicion = "";
        ...
        public bool DaxCombosBods(string Suc, bool todo, string StrCon, ref ComboBox PasCombo, bool deUser = true)
        {
            ...
            condicion = SysEmpDatt.DatosUsuario.Bods.Replace(" ", "','");
            ...
            if (SysEmpDatt.DatosUsuario.codigo.ToUpper() != "ADMINISTRADOR" & SysEmpDatt.DatosUsuario.codigo.ToUpper() != "CONTROL" & deUser)
            {
