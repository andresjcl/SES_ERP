...
Public Class DataGridViewPrinter
    ...
    Private TheTitleText1 As String
    Private TheTitleText2 As String
    ...
    Public Sub New(ByVal aDataGridView As DataGridView, ByVal aPrintDocument As PrintDocument, ByVal CenterOnPage As Boolean, ByVal WithTitle As Boolean, ByVal aTitleText As String, ByVal aTitleText1 As String, ByVal aTitleText2 As String, ByVal aTitleFont As Font,
     ByVal aTitleColor As Color, ByVal WithPaging As Boolean)
        ...
        TheTitleText1 = aTitleText1
        TheTitleText2 = aTitleText2
    ...
    Private Sub Calculate(ByVal g As Graphics)
        If PageNumber = 0 Then
            ...
            For i As Integer = 0 To TheDataGridView.Columns.Count - 1
                ...
                RowHeaderHeight = TheDataGridView.Columns(i).HeaderCell.Size.Height
    ...
    Private Sub DrawHeader(ByVal g As Graphics)
        ...
        If IsWithPaging Then
            PageNumber += 1
            Dim PageString As String = "Pag: " & PageNumber.ToString() & "  ."
        ...
        If IsWithTitle Then
            ...
            If TheTitleText1 > "" Then
                TitleRectangle = New RectangleF(CSng(LeftMargin), CurrentY, CSng(PageWidth) - CSng(RightMargin) - CSng(LeftMargin), g.MeasureString(TheTitleText1, TheTitleFont).Height)

                g.DrawString(TheTitleText1, TheTitleFont, New SolidBrush(TheTitleColor), TitleRectangle, TitleFormat)

                CurrentY += g.MeasureString(TheTitleText1, TheTitleFont).Height
            End If

            If TheTitleText2 > "" Then
                TitleRectangle = New RectangleF(CSng(LeftMargin), CurrentY, CSng(PageWidth) - CSng(RightMargin) - CSng(LeftMargin), g.MeasureString(TheTitleText2, TheTitleFont).Height)

                g.DrawString(TheTitleText2, TheTitleFont, New SolidBrush(TheTitleColor), TitleRectangle, TitleFormat)

                CurrentY += g.MeasureString(TheTitleText2, TheTitleFont).Height
            End If
        End If
