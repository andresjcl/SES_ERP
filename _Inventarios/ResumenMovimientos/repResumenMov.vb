...
#Region "Datos Iniciales"
    ...
    Private Sub llenarCombos()
        ...
        llenarCategorias(ssql, cboCategoria, "Todas las categorias", "Niv_nombre", "Niv_abrevia", Label3)
        ...
        llenarCategorias(ssql, cboClase, "Todas las clases", "Niv_nombre", "Niv_abrevia", Label4)
        ...
        llenarCategorias(ssql, cboGrupo, "Todos los grupos", "Niv_nombre", "Niv_abrevia", Label5)
        ...
        llenarCategorias(ssql, cboSubg, "Todos los subgrupos", "Niv_nombre", "Niv_abrevia", Label6)
        llenarBodegas()
    End Sub
    Private Sub llenarCategorias(ByVal ssql As String, ByVal cbo As ComboBox, ByVal op As String, ByVal nombre As String, ByVal cod As String, lcbo As Label)
...
#Region "Reportes"
    ...
    Private Sub reporte()
        ...
        Dim ConCategoria As New ReportParameter("ConCategoria", CCat)
        Dim ConClase As New ReportParameter("ConClase", CCla)
        Dim ConGrupo As New ReportParameter("ConGrupo", CGru)
        Dim ConSubgrupo As New ReportParameter("ConSubgrupo", CSub)
        ...
        ReportViewer1.LocalReport.ReportPath = datosEmpresa.pathAppl & "BinNet\Rep\Movimiento.rdlc"
...
#End Region
    ...
    Private Sub Ordenarporsoporte_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        limpiarReporte()
    End Sub

    Private Sub cboDocumentos_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        limpiarReporte()
    End Sub

    Private Sub CboSoporte_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        limpiarReporte()
    End Sub
