...
namespace DaxInvent
{
    public partial class Form1 : Form
    {
        ...
        private void ImprimirToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            preparaTitulo();
            imp.imprimir(mallaDatos, tit1, tit2, DattCom.datosEmpresa.Emp_Nombre);
        }
        ...
        private void WordToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            preparaTitulo();
            exp.Exportar(mallaDatos, "W", DattCom.datosEmpresa.Emp_Nombre, tit1 + "\r\n" + tit2);
        }
        ...
        private void ExcelToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            mallExp.Form1 exp = new mallExp.Form1();
            preparaTitulo();
            exp.Exportar(mallaDatos, "E", DattCom.datosEmpresa.Emp_Nombre, tit1 + "\r\n" + tit2);
        }
        ...
        private void PDFToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            mallExp.Form1 exp = new mallExp.Form1();
            preparaTitulo();
            exp.Exportar(mallaDatos, "P", DattCom.datosEmpresa.Emp_Nombre, tit1 + "\r\n" + tit2);
        }
