...
{ 
    ...
    {
        static public double UltimoPrecioVenta(string Sucursal,string Cliente,string Articulo,Boolean Pantalla,string EnMedida,string TipoDoc, DateTime AlaFecha, string strConxAdcom,string strIniSis)
        {
            ...
            if (RsCosUlt.Rows.Count > 0)
            {
                ...
                {
                    Auxnum = medidas.MulMedida(RsCosUlt.Rows[0]["Medida"].ToString(), EnMedida, strIniSis);
                    if (Auxnum != 0 )
                    {
        ...
        static public double UltimoCostoCompra(string Sucursal, string Proveedor, string Articulo, Boolean Pantalla, string EnMedida, string TipoDoc, DateTime AlaFecha, string strConxAdcom, string strIniSis)
        {
