...
#Region "Datos Iniciales"
    ...
    Private Sub FrmNiveles_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If esActivo Then
            Me.Text = "ADCOMDAX - ADMINISTRAR AGRUPACIÓN DE ACTIVOS FIJOS" : tabla = "AdcnivAcf"
            etiqueta = "Activos"
        Else
            Me.Text = "ADCOMDAX - ADMINISTRAR AGRUPACIÓN DE ARTÍCULOS DE INVENTARIO" : tabla = "AdcNiv"
            etiqueta = "Artículos"
        End If
...
#Region "Malla"
    ...
    Private Sub malla_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles malla.CellEndEdit
        If col = 0 Then
            If VerificarExistencia(malla.Rows(fila).Cells("Niv_Abrevia").Value.ToString()) = True Then MsgBox("La abreviación ingresada ya existe", MsgBoxStyle.Information) : malla.Rows(fila).Cells("Niv_Abrevia").Value = "" : malla.ClearSelection()
        End If
    End Sub
...
#Region "Imprimir"
    ...
    Private Sub imprimir()
        ...
        Dim opc As String = "I"
        If esActivo Then opc = "A"
        imp.Imprimir(ssql, "Adcomdax - Reporte de Niveles de " & etiqueta, datosEmpresa.codEmpresa.ToString())
    End Sub
#End Region
