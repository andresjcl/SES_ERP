...
namespace DaxInvent
{
    public partial class FrmMantMed : Form
    {
        ...
        {
            DataTable dt = SqlDatos.leerTablaDaxsys("select * from conversion where Cnv_DeMedida='" + cod + "'");
            MALLA.DataSource = dt;
            //accion = "Abrir";
            Bloquear(false);
        }
        ...
        {
            Syscod.ClassSyscod  s = new Syscod.ClassSyscod (datosEmpresa.strConxDaxsys);
        ...
        private void guardarConv(string cod)
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter(ssql,datosEmpresa.strConxDaxsys))
            {
        ...
        private void Eliminar(string cod)
        {
            ...
            {
                SqlDatos.ejecutarComandoDaxsys("Delete conversion where cnv_demedida = '" + cod + "'");
            }
        }
