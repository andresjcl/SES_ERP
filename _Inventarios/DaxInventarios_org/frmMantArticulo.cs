    ...
    internal partial class MantArticulo : Form
    {
       ...
       // string sSQLTIKETS = "";
        ...
        private void moverCLaseADatos()
        {
            ...
            txtMinimaCompra.Text = artDatos.Art_minbod.ToString();
            ...
            MantCtb.Cuenta ctactb = new MantCtb.Cuenta();
        ...
        private void moverDatosAClase()
        {
            ...
            artDatos.Art_minbod=Convert.ToDecimal("0" + txtMinimaCompra.Text);
