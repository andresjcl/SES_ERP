...
namespace DaxInvent
{
    internal partial class EntregasRealizadasClienteProv : Form
    {
        internal EntregasRealizadasClienteProv(string docSuc,string docTip,string docNum,double docIdclave,string conxadc)
        {
            InitializeComponent();
