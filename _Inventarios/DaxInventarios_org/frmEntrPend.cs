...
namespace DaxInvent
{
    public partial class frmEntrPend : Form
    {
        ...
        public frmEntrPend(string conxadc,string clieOprod, string cod, string nom)
        {
            InitializeComponent();
        ...
        {
            prepararSalida();
            frmArtEntr prog = new frmArtEntr(docsuc, docOpc, docNumero, 0, strConxAdcom);
            prog.ShowDialog();
            prog.Dispose();
        }
