...
namespace DaxInvent
{
    ...
    public partial class frmBuscaArticuloSimple : Form
    {
        ...
        {
            //dato, StrConxAdcom_10, StrConxDaxSys_10, "", "", "", "", CDate(TxtFecha)
            InitializeComponent();
            //strConxAdcom = strconx;
            //strConxDaxsys = strdaxsys;
...
//            llenarCombos(datosEmpresa.strConxAdcom);
        ...
        {
            if (cmbCategoria.SelectedValue != null) registraEvntos.registrar.registraPreferencia(datosEmpresa.strConxSyscod, datosEmpresa.codEmpresa.ToString(), datosEmpresa.usr + Environment.MachineName, "DAX", datosEmpresa.suc, "BUSART", "CategoriaArticulo", cmbCategoria.SelectedValue.ToString());
            if (cmbClase.SelectedValue != null) registraEvntos.registrar.registraPreferencia(datosEmpresa.strConxSyscod, datosEmpresa.codEmpresa.ToString(), datosEmpresa.usr + Environment.MachineName, "DAX", datosEmpresa.suc, "BUSART", "ClaseArticulo", cmbClase.SelectedValue.ToString());
            if (cmbGrupo.SelectedValue != null) registraEvntos.registrar.registraPreferencia(datosEmpresa.strConxSyscod, datosEmpresa.codEmpresa.ToString(), datosEmpresa.usr + Environment.MachineName, "DAX", datosEmpresa.suc, "BUSART", "GrupoArticulo", cmbGrupo.SelectedValue.ToString());
        }
        private void cargarPreferencias()
        {

            string op = registraEvntos.registrar.obtenerPreferencia(datosEmpresa.strConxSyscod, datosEmpresa.codEmpresa.ToString(), datosEmpresa.usr + Environment.MachineName, "DAX", datosEmpresa.suc, "BUSART", "CategoriaArticulo");
            if (op.Length > 0) cmbCategoria.SelectedValue = op; else cmbCategoria.SelectedIndex = 0;

            op = registraEvntos.registrar.obtenerPreferencia(datosEmpresa.strConxSyscod, datosEmpresa.codEmpresa.ToString(), datosEmpresa.usr + Environment.MachineName, "DAX", datosEmpresa.suc, "BUSART", "ClaseArticulo");
            if (op.Length > 0) cmbClase.SelectedValue = op; else cmbClase.SelectedIndex = 0;

            op = registraEvntos.registrar.obtenerPreferencia(datosEmpresa.strConxSyscod, datosEmpresa.codEmpresa.ToString(), datosEmpresa.usr + Environment.MachineName, "DAX", datosEmpresa.suc, "BUSART", "GrupoArticulo");
