...
namespace DaxInvent
{
    public partial class Form1 : Form
    {
        ...
        private void FrmFacSinRet_Load(object sender, EventArgs e)
        {
            ...
            strConxAdcom = SysEmpDatt.datosEmpresa.strConxAdcom;
        }
        ...
        private void ImprimirToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            preparaTitulo();
            imp.imprimir(mallaDatos, tit1, tit2, SysEmpDatt.datosEmpresa.Emp_Nombre);
        }
        ...
        private void WordToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            preparaTitulo();
            exp.Exportar(mallaDatos, "W", SysEmpDatt.datosEmpresa.Emp_Nombre, tit1 + "\r\n" + tit2);
        }
        ...
        private void ExcelToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ExportarGrid.Form1 exp = new ExportarGrid.Form1();
            preparaTitulo();
            exp.Exportar(mallaDatos, "E", SysEmpDatt.datosEmpresa.Emp_Nombre, tit1 + "\r\n" + tit2);
        }
        ...
        private void PDFToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            ExportarGrid.Form1 exp = new ExportarGrid.Form1();
            preparaTitulo();
            exp.Exportar(mallaDatos, "P", SysEmpDatt.datosEmpresa.Emp_Nombre, tit1 + "\r\n" + tit2);
        }
