...
namespace Adcmvart
{
    public partial class frmMovArt : Form
    {
        string tit1 = "";
        string tit2 = "";
        string strConxadcom = "";
        ...
        private void cargarCombos()
        {
            ...
            cmb.DaxCombosBods ("", true,datosEmpresa.strConxAdcom, ref comboBox1);
        }
        ...
        private void buscarArticulo()
        {
            ...
            string codart = businv.Buscar(strConxadcom, "SELECT Art_codigo as Codigo, Art_nombre as Descripción, Art_unimed as UnMedida FROM AdcArt ", "Codigo", "Descripción", "C", "BUSQUEDA DE ARTÍCULO");
        ...
        {
            DataTable dt = leerDatos("Select art_nombre from adcart where art_codigo = '" + codigo + "'");
            if (dt.Rows.Count > 0)
            {
