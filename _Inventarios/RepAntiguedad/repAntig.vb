...
#Region "Reportes"
    ...
    Private Sub reporte()
        ...
        cad = "DaxInvAntg '" & fecha & "','" & bodega & "','" & codIni & "','" & codFin & "'," & articulosExiten & ",'" & costeo & "','" & categoria & "','" & clase & "','" & grupo & "','" & subg & "','" & Ordenar & "'"
        ...
        ReportViewer1.LocalReport.ReportPath = datosEmpresa.pathAppl & "BinNet\Rep\InvAntg.rdlc"
...
#End Region
    ...
    Private Sub repAntig_Load(sender As Object, e As EventArgs) Handles MyBase.Load
