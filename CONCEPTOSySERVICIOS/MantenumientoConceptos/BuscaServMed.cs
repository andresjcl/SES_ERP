...
namespace DaxConceptos
{
    public partial class BuscaServMed : Form
    {
        ...
        {
            AuditSis.registrar.registraPreferencia(datosEmpresa.strConxAdcom, datosEmpresa.codEmpresa.ToString(),Environment.MachineName, datosEmpresa.usr + Environment.MachineName, datosEmpresa.sistema, datosEmpresa.suc, "SERVICIOS", "ClaseServicio", cmbClase.SelectedValue.ToString());
            AuditSis.registrar.registraPreferencia(datosEmpresa.strConxAdcom, datosEmpresa.codEmpresa.ToString(),Environment.MachineName, datosEmpresa.usr + Environment.MachineName, datosEmpresa.sistema, datosEmpresa.suc, "SERVICIOS", "GrupoServicio", cmbGrupos.SelectedValue.ToString());
        }
