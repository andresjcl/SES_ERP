...
{
    public partial class PreciosVentaCliente : Form
    {
        string todos = "Todos";
        ...
        private void LlenarCombos()
        {
            ...
            cmb.DaxCombosCat("C", "I", datosEmpresa.strConxAdcom, ref cboCategoria);
            cboCategoria.SelectedValue = "0";

            cmb.DaxCombosCat("CL", "I", datosEmpresa.strConxAdcom, ref cboClase);
            cboClase.SelectedValue = "0";

            cmb.DaxCombosCat("G", "I", datosEmpresa.strConxAdcom, ref cboGrupo);
        ...
        {
            BuscaClien directorio = new BuscaClien();
            string cliente = "C";
            string codigo = "";
            string nombre = "";
            string conalias = "N";
        ...
        private void btnAbrir_Click(object sender, EventArgs e)
        {
            ...
            string lista  = "";
            lista = bus.Buscar(datosEmpresa.strConxAdcom , "select Lista, Descripción from  adcPrvtaLis where Lista <> '' ", "Lista", "Descripción", "Consulta", "LISTAS DE PRECIO:");
            if (lista != "" )
            {
        ...
        {
            EmpNomR.AdcNomb Nombres = new EmpNomR.AdcNomb ();
            DaxComercia.AdcPrvtaLis lista = new DaxComercia.AdcPrvtaLis(datosEmpresa.strConxAdcom);
            ...
            {
                txtClienteNombre.Text = Nombres.RetornaNombreDirectorio  (txtClienteCod.Text ,datosEmpresa. strConxAdcom );
            }
            
            txtPaisCod.Text = lista.Pais;
            txtPais.Text = Nombres.RetornaNombreSyscod ("Paises",txtPaisCod.Text, datosEmpresa.strConIniSis);
            txtTipoClienteCod.Text = lista.TipoCliente;
            txtTipocliente.Text  = Nombres.RetornaNombreSyscod("TipoCliente", txtTipoClienteCod.Text, datosEmpresa.strConIniSis);
    ...
    {
        Int64 numeroLista = 0;
        SqlConnection conecta = new SqlConnection(datosEmpresa.strConxAdcom );
        conecta.Open ();
    ...
    {
        malla.EndEdit();
        DaxComercia.AdcPrvtaLis pvta = new DaxComercia.AdcPrvtaLis(datosEmpresa.strConxAdcom);
