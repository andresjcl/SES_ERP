...
namespace ClassDoc
{
    public class Servicios
    {
        ...
        private System.String _Sev_Logotipo = "";
        private System.Boolean _Sev_PresentaInmediato = false;
        private string _TipServMedico = "";
        private System.Decimal _Sev_PorIVA = 0;
        ...
        public System.String sev_logotipo
        {
            get
            {
                return ajustarAncho(_Sev_Logotipo, 250);
            }
            set
            {
                _Sev_Logotipo = value;
        ...
        public System.Boolean Sev_PresentaInmediato
        {
            get
            {
                return _Sev_PresentaInmediato;
            }
            set
            {
                _Sev_PresentaInmediato = value;
            }
        }
        public System.String TipServMedico
        {
            get
            {
                return _TipServMedico;
            }
            set
            {
                _TipServMedico = value;
            }
        }

        public System.Decimal Sev_PorIVA
        {
            get
            {
                return _Sev_PorIVA;
        ...
        private static Servicios row2AdcServ(DataRow r)
        {
            ...
            try
            {
                oAdcServ.Sev_SriBien = System.Int16.Parse(r["Sev_SriBien"].ToString());
            }
            catch { oAdcServ.Sev_SriBien = 0; }
            ...
            oAdcServ.sev_logotipo = r["Sev_Logotipo"].ToString();
            try
            {
                oAdcServ.Sev_PresentaInmediato = System.Boolean.Parse(r["Sev_PresentaInmediato"].ToString());
            }
            catch
            {
                oAdcServ.Sev_PresentaInmediato = false;
            }
            oAdcServ.TipServMedico = r["TipServMedico"].ToString();

            oAdcServ.Sev_PorIVA = System.Decimal.Parse("0" + r["Sev_PorIVA"].ToString());
        ...
        private static void AdcServ2Row(Servicios oAdcServ, DataRow r)
        {
            ...
            r["Sev_Logotipo"] = oAdcServ.sev_logotipo;
            r["Sev_PresentaInmediato"] = oAdcServ.Sev_PresentaInmediato;
            r["TipServMedico"] = oAdcServ.TipServMedico;
            r["Sev_PorIVA"] = oAdcServ.Sev_PorIVA;
        ...
        private static void nuevoAdcServ(DataTable dt, Servicios oAdcServ)
        {
            ...
            oA.sev_logotipo = oAdcServ.sev_logotipo;
            oA.Sev_PresentaInmediato = oAdcServ.Sev_PresentaInmediato;
            oA.TipServMedico = oAdcServ.TipServMedico;
            oA.Sev_PorIVA = oAdcServ.Sev_PorIVA;
            //
            AdcServ2Row(oA, dr);
            //
            dt.Rows.Add(dr);
        ...
        public string Clasificadores(sesSys.OpcDoc opopc)
        {
            string lacuenta = "";
            return ClasificadorYcuenta(opopc, ref lacuenta);
        }

        public string ClasificadorYcuenta(sesSys.OpcDoc opopc, ref string CtaCont)
        {
            ...
            //string lugar = "";
            string CYC = "";
            if (sev_escontable) { cuentaa = Sev_codigo; }
            else if (opopc.TipoDoc == "" || opopc.nombre == "") { return CYC; }
            else
            {
                //opopc.Cargar(ref Tipodoc, ref lugar);
