...
namespace DaxGesvta
{
    class sb_util
    {
        ...
        public string armarSelectConsulta(string txtFechaDel, string txtFechaAl, string GessConsulta,ref sb_datosMalla datosMalla,ref string SSqlorder)
        {
            ...
            agregarFiltros(ref SSqlwhere, ref comawhere,ref datosMalla);
            agregarOrdenamiento(ref SSqlorder, ref comaorder,ref datosMalla);
        ...
        private void agregarFiltros(ref string SSqlw, ref string comaw, ref sb_datosMalla datosMalla)
        {
            comaw = " and ";
            foreach (sb_columna column in datosMalla.columnas)
            {
        ...
        {
            Int32 NroCampos = datosMalla.columnas.Count;
