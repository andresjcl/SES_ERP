...
#Region "Cambios"
    ...
    Private Sub txtCasilla_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCasilla.TextChanged
        cambios += 1
    End Sub
...
#Region "Guardar/Modificar"
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        If accion = "G" Then
            ...
            End If
        End If
        MsgBox("Los cambios efectuados no serán efectivos hasta que reinicie el sistema ADCOMdx", MsgBoxStyle.Information)
        cancelar()
    End Sub
