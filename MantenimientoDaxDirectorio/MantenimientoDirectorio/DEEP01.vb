...
Public Class DEEP01
    ...
    Private esperandoValidacion As Boolean = False
    Private ultimoPasaporteValidado As String = ""
    Private generandoCodigo As Boolean = False
    ...
    Private Sub Asociacion_CheckStateChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Asociacion.CheckStateChanged
        ' PonerDatosTipo()
    End Sub
    ...
    Private Sub CBuscador8_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBuscador8.Click
        Dim ElCodigo As String = ""
        Dim BusPAG As New Buscar.frmBuscar   'DaxPagos.BuscadorPagos
        Dim sSql As String = "select top 100 percent idFormasDePago,Descripcion as Descripción from formasdepago where tipoformapago <> 2 order by Descripcion"
        ElCodigo = BusPAG.Buscar(datosEmpresa.strConxAdcom, sSql, "idFormasDePago", "Descripción", "", "Formas de pago clientes")
    ...
    Private Sub CBuscador11_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBuscador11.Click
        CBuscador(Lcod11, 11)
    End Sub
    ...
    Private Sub ComCtb1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ComCtb1.Click
        cuenta(Cuenta2, Keys.F2, 0 \ &H10000)
    End Sub

    Private Sub Comctb2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Comctb2.Click
    ...
    Private Sub Banco_CheckStateChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Banco.CheckStateChanged
    ...
    Private Sub DEEP01_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        Try
            ...
            If Empleado.CheckState = 1 Then

                Dim tablaemp As New dbEmpleado(datosEmpresa.strConxAdcom)

                MoverDatosEmpleado.moverDatos(Me, tablaemp, TipCodSyscod, codigoDirectorio(2), CodSuc)

                With tablaemp
                    Dim elError As String
                    elError = .Actualizar("select * from empleado where codigoempleado = '" & QUECODIGO & "' ")
                    If elError.Substring(0, 5) = "ERROR" Then
                        MsgBox("El registro empleado no puede grabarse " + vbCr + elError, MsgBoxStyle.Exclamation)
                    Else
                        verificaCambios.verificaCambios(LosCambios, tablaemp, accion.ToUpper <> "ACTUALIZAR")
                    End If
                End With
    ...
    Private Sub nivelrol_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles nivelrol.KeyPress
        Dim KeyAscii As Int32 = Asc(e.KeyChar)
        KeyAscii = DaaxLibDat.SoloNumeros(KeyAscii)
        e.KeyChar = Chr(KeyAscii)
        If KeyAscii = 0 Then
    ...
    Private Sub Nroctabancorol_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Nroctabancorol.KeyPress
        Dim KeyAscii As Int32 = Asc(e.KeyChar)
        KeyAscii = DaaxLibDat.SoloNumeros(KeyAscii)
        e.KeyChar = Chr(KeyAscii)
        If KeyAscii = 0 Then
    ...
    Private Sub porcedescuentoprv_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles porcedescuentoprv.KeyPress
        Dim KeyAscii As Int32 = Asc(e.KeyChar)
        KeyAscii = DaaxLibDat.SoloNumeros(KeyAscii)
        e.KeyChar = Chr(KeyAscii)
        If KeyAscii = 0 Then
    ...
    Private Sub Proveedor_CheckStateChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Proveedor.CheckStateChanged
        ' PonerDatosTipo()
        Try
            If Proveedor.Checked Then
    ...
    Private Sub DEEP01_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CargarRegistros()
        Try
            ...
            Else
                ...
                leerCliente()
                leerProveedor()
                LeerEmpleado.leerEmpleado(Me, QUECODIGO, TipCodSyscod, LosCambios, codigoDirectorio)
                leerContactos()
                leerAlias()
                leerFamiliares()
                EsNuevo = 2
    ...
    Private Sub PonerBotonesFormulario()
        ...
        Me.Text = "Mantenimiento de Directorio -  " & Operacion(EsNuevo)
    End Sub
    ...
    Private Sub valorsueldo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles valorsueldo.KeyPress
        Dim KeyAscii As Int32 = Asc(e.KeyChar)
        KeyAscii = DaaxLibDat.SoloNumeros(KeyAscii)
        e.KeyChar = Chr(KeyAscii)
        If KeyAscii = 0 Then
    ...
    Private Sub CbuscaDir2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CbuscaDir2.Click
        Dim dat(2) As String
        dat = CbuscaDir("F", 0)
    ...
    Private Sub Cliente_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cliente.CheckedChanged
        PonerDatosTipo()
    End Sub

    Private Sub Proveedor_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Proveedor.CheckedChanged
        PonerDatosTipo()
    End Sub

    Private Sub Banco_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Banco.CheckedChanged
        PonerDatosTipo()
    End Sub

    Private Sub Empleado_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Empleado.CheckedChanged
        PonerDatosTipo()
    End Sub

    Private Sub EsVendedor_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EsVendedor.CheckedChanged
        PonerDatosTipo()
    End Sub

    Private Sub Directa_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Directa.CheckedChanged
        PonerDatosTipo()
    End Sub

    Private Sub Asociacion_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Asociacion.CheckedChanged
        PonerDatosTipo()
    End Sub
...
#End Region
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        If (TxtCedulaRuc.Text.Length = 0 Or Codigo.Text.Length = 0) Then Return

        Try
            Dim prog As New ImpresionDocumentosDax.ImprimeConsulta("&DaxDirdir '" & Codigo.Text & "'", "0", "HojDir")
            prog.ShowDialog()
        Catch ex As Exception
            MessageBox.Show("El formato de impresión (HojDir), para la hoja de datos, no está definido correctamente ")
        End Try
    ...
    Private Sub ComCargarCapacitacion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCargarCapacitacion.Click
    ...
    Private Sub mallaDatos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles mallaDatos.KeyDown
    ...
    Private Sub Label68_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles Label73.DoubleClick, Label72.DoubleClick, Label71.DoubleClick, Label70.DoubleClick, Label69.DoubleClick, Label68.DoubleClick
        Dim progg As New Syscod.ManSysnetClass
    ...
    Private Sub Grupo1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Grupo1.KeyDown
        If e.KeyCode = Keys.F2 Then
    ...
    Private Sub mallaConceptos_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles mallaConceptos.KeyDown
        Dim codigo As String = ""
        Dim Descripción As String = ""
        With mallaConceptos
            Select Case e.KeyCode
    ...
    Private Sub mallaDatos_CellValueChanged(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles mallaDatos.CellValueChanged
        CambioAdicionales = True
    End Sub

    Private Sub Grupo2_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles Grupo2.KeyDown
        If e.KeyCode = Keys.F2 Then
            CBuscadorGrupo(Grupo2, Label69.Text)
        End If
    End Sub

    Private Sub Grupo3_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles Grupo3.KeyDown
        If e.KeyCode = Keys.F2 Then
            CBuscadorGrupo(Grupo3, Label70.Text)
        End If
    End Sub
    Private Sub Grupo4_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles Grupo4.KeyDown
        If e.KeyCode = Keys.F2 Then
            CBuscadorGrupo(Grupo4, Label71.Text)
        End If
    End Sub
    Private Sub Grupo5_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles Grupo5.KeyDown
        If e.KeyCode = Keys.F2 Then
            CBuscadorGrupo(Grupo5, Label72.Text)
        End If
    End Sub
    Private Sub Grupo6_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles Grupo6.KeyDown
        If e.KeyCode = Keys.F2 Then
    ...
    Private Sub cmbPaisDomicilio_Leave(sender As Object, e As EventArgs) Handles cmbRegionNace.Leave, cmbRegionDomicilio.Leave, cmbProvinciaNace.Leave, cmbProvinciaDomicilio.Leave, cmbProfesion.Leave, cmbParroquiaDomicilio.Leave, cmbPaisNace.Leave, cmbPaisDomicilio.Leave, cmbNacionalidadPersonal.Leave, cmbEspecialidad2.Leave, cmbEspecialidad.Leave, cmbCiudadNace.Leave, cmbCiudadDomicilio.Leave, cmbCantonDomicilio.Leave
        Dim cmb As ComboBox = CType(sender, ComboBox)
        If IsNothing(cmb.SelectedValue) Then cmb.Text = ""
    End Sub

    Private Sub cmbProvinciaDomicilio_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbProvinciaDomicilio.SelectedIndexChanged
        CargarCantonDomilio()
    End Sub
    Private Sub CargarProvinciasDomicilio()
        dc.DaxCombosReferencia("Provincias", datosEmpresa.strConxAdcom, cmbProvinciaDomicilio, "S")
    End Sub
    Private Sub CargarCantonDomilio()
        dc.DaxCombosCantones(datosEmpresa.strConxAdcom, cmbCantonDomicilio, False, provincia(), True)
        CargarParroquiaDomicilio()
        CargarCiudadDomicilio()
    End Sub
    Private Sub CargarParroquiaDomicilio()
        dc.DaxCombosParroquias(datosEmpresa.strConxAdcom, cmbParroquiaDomicilio, False, provincia, canton, True)
    End Sub
    Private Sub CargarCiudadDomicilio()
        Dim prov As String = provincia()
        If (prov = "") Then Return
        dc.DaxCombosCiudades(datosEmpresa.strConxAdcom, cmbCiudadDomicilio, False, prov, canton())
        regionDomicilio()
    End Sub
    Private Sub regionDomicilio()
        Dim reg As String = "0"
    ...
    End Sub
    Private Sub regionNacimiento()
        'Dim reg As String = "0"
        'If IsNothing(cmbCiudadNace.SelectedValue) = False Then
        '    reg = cmbCiudadNace.SelectedValue.ToString().Substring(0, 1)
        'End If
        'cmbRegionNace.SelectedValue = reg
        Dim reg As String = "0"

        If cmbCiudadNace.SelectedValue IsNot Nothing AndAlso cmbCiudadNace.SelectedValue.ToString().Length > 0 Then
            reg = cmbCiudadNace.SelectedValue.ToString().Substring(0, 1)
        End If

        cmbRegionNace.SelectedValue = reg
    End Sub
    Private Function provincia() As String
        Dim prv As String = ""
        Try
        ...
        Return prv
    End Function
    Private Function canton() As String
        Dim prv As String = ""
        Try
            prv = cmbCantonDomicilio.SelectedValue.ToString().Substring(2, 2)
        Catch ex As Exception
            prv = ""
        End Try
        Return prv
    ...
    Private Sub cmbPaisNacimiento_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbPaisNace.SelectedIndexChanged
        If saltar = False Then
            CargarProvinciasNacimiento()
            CargarCiudadNacimiento()
        End If
    End Sub
    Private Sub cmbProvinciaNacimiento_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbProvinciaNace.SelectedIndexChanged
        CargarCiudadNacimiento()
    End Sub
    Private Sub CargarProvinciasNacimiento()
        dc.DaxCombosReferencia("Provincias", datosEmpresa.strConxAdcom, cmbProvinciaNace, "S")
    End Sub
    'Private Sub CargarCantonNacimiento()
    '    dc.DaxCombosCantones(datosEmpresa.strConxAdcom, cmbcan cmbCantonN, False, "S")
    'End Sub
    'Private Sub CargarParroquiaNacimiento()
    '    dc.DaxCombosParroquias(datosEmpresa.strConxAdcom, cmbparroquiaNace, False, provinciaN, cantonN, True)
    'End Sub
    Private Sub CargarCiudadNacimiento()
        dc.DaxCombosCiudades(datosEmpresa.strConxAdcom, cmbCiudadNace, False, provinciaN(), "")
        regionNacimiento()
    End Sub
    Private Function provinciaN() As String
        Dim prv As String = ""
        Try
    ...
    Private Sub cmbCiudadDomicilio_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbCiudadDomicilio.SelectedIndexChanged
        regionDomicilio()
    End Sub

    Private Sub cmbCiudadNace_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbCiudadNace.SelectedIndexChanged
        regionNacimiento()
    End Sub

    Private Sub cmbCantonDomicilio_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbCantonDomicilio.SelectedIndexChanged
        CargarCiudadDomicilio()
    End Sub

    Private Sub cmbPaisDomicilio_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbPaisDomicilio.SelectedIndexChanged
        CargarProvinciasDomicilio()
    End Sub

    Private Sub tabDatosPer_Click(sender As Object, e As EventArgs) Handles tabDatosPer.Click

    End Sub

    Private Sub TipoIdent_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TipoIdent.SelectedIndexChanged
        ' Generar código automático cuando cambia el tipo de identificación
        If TxtCedulaRuc.Text.Trim() <> "" Then
            If TipoIdent.Text = "Pasaporte" Then
                ' Para pasaporte, verificar si existe antes de generar
                Dim pasaporte As String = LimpiarPasaporte(TxtCedulaRuc.Text)
                Dim codigoExistente As String = BuscarCodigoPorIdentificacion(pasaporte)

                If codigoExistente <> "" AndAlso codigoExistente <> Codigo.Text Then
                    Dim resultado As DialogResult = MessageBox.Show(
                    "Ya existe un registro con este pasaporte." & vbCrLf &
                    "Código: " & codigoExistente & vbCrLf & vbCrLf &
                    "¿Desea cargarlo?",
                    "Pasaporte Existente",
        ...
        End If
    End Sub
    Private Sub TxtCedulaRuc_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtCedulaRuc.TextChanged
        ' Solo generar código automático, sin validar existencia
        If TipoIdent.SelectedIndex >= 0 AndAlso TipoIdent.Text <> "Pasaporte" Then
            GenerarCodigoAutomatico()
        ElseIf TipoIdent.SelectedIndex >= 0 AndAlso TipoIdent.Text = "Pasaporte" Then
            ' Para pasaporte, solo generar si es nuevo (no validar aquí)
            Dim textoLimpio As String = LimpiarPasaporte(TxtCedulaRuc.Text)
            Dim codigoExistente As String = BuscarCodigoPorIdentificacionExacta(textoLimpio)
    ...
    Private Sub GenerarCodigoAutomatico()
        ' Evitar recursión
        If generandoCodigo Then Return
        generandoCodigo = True

        Try
            Dim tipoSeleccionado As String = TipoIdent.Text
            Dim numeroIdent As String = TxtCedulaRuc.Text.Trim()
            Dim codigoGenerado As String = ""

            If String.IsNullOrEmpty(numeroIdent) Then
                Codigo.Text = ""
            ...
            Select Case tipoSeleccionado
                Case "Registro U Contribuyente", "RUC"
                    Dim numeros As String = ExtraerNumeros(numeroIdent)
                    If numeros.Length >= 10 Then
                        codigoGenerado = "R" + numeros.Substring(0, 10)
                    Else
                        codigoGenerado = "R" + numeros.PadLeft(10, "0"c)
                    End If
                    Codigo.Text = codigoGenerado

                Case "Cédula Identidad", "Cédula"
                    Dim numeros As String = ExtraerNumeros(numeroIdent)
                    If numeros.Length >= 10 Then
                        codigoGenerado = "C" + numeros.Substring(0, 10)
                    Else
                        codigoGenerado = "C" + numeros.PadLeft(10, "0"c)
                    End If
                    Codigo.Text = codigoGenerado

                Case "Pasaporte"
                    Dim textoLimpio As String = LimpiarPasaporte(numeroIdent)

                    ' Buscar coincidencia EXACTA
                    Dim codigoExistente As String = BuscarCodigoPorIdentificacionExacta(textoLimpio)

                    If Not String.IsNullOrEmpty(codigoExistente) Then
                        ' Si ya existe exactamente este pasaporte, no generar nuevo código
                        ' Dejar que el Validating maneje la situación
                        generandoCodigo = False
                        Return
                    Else
                        ' Si no existe, generar nuevo código
                        If textoLimpio.Length >= 10 Then
                            codigoGenerado = "P" + textoLimpio.Substring(0, 10)
                        Else
                            codigoGenerado = "P" + textoLimpio
                        End If
                        Codigo.Text = codigoGenerado
                    End If

                Case "Consumidor Final"
                    codigoGenerado = "C9999999999"
                    Codigo.Text = codigoGenerado
        ...
        Catch ex As Exception
            MessageBox.Show("Error al generar código automático: " + ex.Message)
        Finally
            generandoCodigo = False
        End Try
    End Sub

    Private Function BuscarCodigoPorIdentificacion(ByVal numeroIdentificacion As String) As String
        ' Busca si ya existe un código para este número de identificación
        Try
            If numeroIdentificacion = "" Then Return ""

            ' Buscar en la tabla identificacion por el número de cédula/ruc/pasaporte
            Dim sql As String = "SELECT codigo FROM identificacion " &
                           "WHERE cedulaidentidadruc = '" & numeroIdentificacion & "'"

            ' Si estamos editando un registro, excluir el actual
            If Codigo.Text <> "" Then
                sql = "SELECT codigo FROM identificacion " &
                  "WHERE cedulaidentidadruc = '" & numeroIdentificacion & "' " &
                  "AND codigo <> '" & Codigo.Text & "'"
            End If

            Dim dt As DataTable = EjecutarConsulta(sql)
        ...
        Catch ex As Exception
            Debug.WriteLine("Error buscando identificación: " + ex.Message)
        End Try
    ...
    Public Function EjecutarConsulta(ByVal sql As String) As DataTable
        Try
            Using con As New SqlClient.SqlConnection(datosEmpresa.strConxAdcom)
    ...
    Private Function GenerarCodigoAlternativo(ByVal codigoOriginal As String, ByVal tipoSeleccionado As String) As String
        ' Genera un código alternativo si el original ya existe
        Dim base As String = codigoOriginal
        Dim contador As Integer = 2

        ' Limitar longitud máxima del código a 11 caracteres
        Dim maxLength As Integer = 11

        While CodigoExiste(base)
            If tipoSeleccionado = "Pasaporte" Then
                base = codigoOriginal.Substring(0, Math.Min(9, codigoOriginal.Length)) & contador.ToString()
            Else
                ' Para RUC y Cédula, agregar sufijo numérico
                If base.Length + 1 <= maxLength Then
                    base = codigoOriginal & contador.ToString()
                Else
                    base = codigoOriginal.Substring(0, maxLength - 1) & contador.ToString()
                End If
            End If
            contador += 1
            If contador > 99 Then Exit While
        End While

        Return base
    End Function

    Private Function BuscarCodigoPasaporteExistente(ByVal pasaporte As String) As String
        ' Busca si ya existe un código para este pasaporte en la base de datos
        Try
            If pasaporte = "" Then Return ""

            ' Buscar en la tabla Personal por número de pasaporte
            ' Asumiendo que el pasaporte se guarda en algún campo (ej: TxtCedulaRuc)
            ' O puedes buscar directamente en la tabla Identificacion por el número de identificación

            Dim sql As String = "SELECT i.codigo FROM identificacion i " &
                                "INNER JOIN personal p ON p.codigoper = i.codigo " &
                                "WHERE i.cedulaidentidadruc = '" & pasaporte & "' AND i.codigo LIKE 'P%'"

            ' Si estamos editando un registro, excluir el actual
            If Codigo.Text <> "" Then
                sql = "SELECT i.codigo FROM identificacion i " &
                      "INNER JOIN personal p ON p.codigoper = i.codigo " &
                      "WHERE i.cedulaidentidadruc = '" & pasaporte & "' " &
                      "AND i.codigo LIKE 'P%' AND i.codigo <> '" & Codigo.Text & "'"
            End If
        ...
        Catch ex As Exception
            ...
            Debug.WriteLine("Error buscando pasaporte: " + ex.Message)
        End Try

        Return ""
    End Function

    Private Function GenerarCodigoPasaporteNuevo(ByVal pasaporteCorto As String) As String
        ' Genera código NUEVO y ÚNICO para pasaportes con menos de 10 caracteres
        ' Formato: P + pasaporte (sin generar sufijo numérico automático)

        Dim base As String = "P" + pasaporteCorto

        ' Verificar si ya existe un código con exactamente esta base
        If Not CodigoExiste(base) Then
            ' Si no existe, usar la base directamente
            Return base
        End If

        ' Si ya existe la base, buscar el número más alto usado para este pasaporte
        Dim maxNumero As Integer = 0

        Try
            ' Buscar todos los códigos que empiecen con esta base
            Dim sql As String = "SELECT codigo FROM identificacion WHERE codigo LIKE '" & base & "%' AND codigo LIKE 'P%'"

            If Codigo.Text <> "" Then
                sql = "SELECT codigo FROM identificacion WHERE codigo LIKE '" & base & "%' AND codigo LIKE 'P%' AND codigo <> '" & Codigo.Text & "'"
            End If
            ...
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                For Each row As DataRow In dt.Rows
                    Dim codigoExistente As String = row("codigo").ToString()
                    If codigoExistente.Length > base.Length Then
                        Dim sufijo As String = codigoExistente.Substring(base.Length)
                        Dim numero As Integer = 0
                        If Integer.TryParse(sufijo, numero) Then
        ...
        Catch ex As Exception
            Debug.WriteLine("Error buscando sufijos: " + ex.Message)
        End Try

        ' Generar nuevo código con el siguiente número
        Dim nuevoNumero As Integer = maxNumero + 1
        Return base & nuevoNumero.ToString()
    End Function

    Private Function CodigoExiste(ByVal codigoABuscar As String) As Boolean
        ' Verifica si el código ya existe en la base de datos
        Try
            If String.IsNullOrEmpty(codigoABuscar) Then Return False

            Dim sql As String = "SELECT COUNT(*) FROM identificacion WHERE codigo = '" & codigoABuscar & "'"

            ' Si estamos editando un registro existente, excluir el registro actual
            If Not String.IsNullOrEmpty(Codigo.Text) AndAlso Codigo.Text <> codigoABuscar Then
                sql = "SELECT COUNT(*) FROM identificacion WHERE codigo = '" & codigoABuscar & "' AND codigo <> '" & Codigo.Text & "'"
            End If
    ...
    Private Function ExtraerNumeros(ByVal texto As String) As String
        ' Extrae solo dígitos numéricos del texto
    ...
    Private Function LimpiarPasaporte(ByVal texto As String) As String
        ' Limpia el texto del pasaporte (quita espacios y caracteres especiales)
        If String.IsNullOrEmpty(texto) Then Return ""

        Dim resultado As New System.Text.StringBuilder()
        For Each c As Char In texto.ToUpper().Trim()
    ...
    Private Function BuscarCodigoPorIdentificacionExacta(ByVal numeroIdentificacion As String) As String
        ' Busca coincidencia EXACTA del número de identificación
        Try
            If String.IsNullOrEmpty(numeroIdentificacion) Then Return ""
    ...
    Private Sub TxtCedulaRuc_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxtCedulaRuc.Leave
        ' Este evento se dispara cuando realmente se sale del campo
        ' Forzar la validación al salir
        If TxtCedulaRuc.Text.Trim() <> "" AndAlso TipoIdent.Text = "Pasaporte" Then
            Dim args As New System.ComponentModel.CancelEventArgs()
            TxtCedulaRuc_Validating(sender, args)
        End If
    End Sub

    Private Sub TxtCedulaRuc_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TxtCedulaRuc.Validating
        ' Evitar validación mientras se está escribiendo
        If generandoCodigo Then Return

        ' Solo validar si el campo tiene contenido y es Pasaporte
        If String.IsNullOrEmpty(TxtCedulaRuc.Text.Trim()) OrElse TipoIdent.Text <> "Pasaporte" Then
            Return
        End If

        Dim pasaporteIngresado As String = LimpiarPasaporte(TxtCedulaRuc.Text)

        ' Si ya validamos este mismo pasaporte, no repetir
        If ultimoPasaporteValidado = pasaporteIngresado Then
            Return
        End If

        ' Buscar coincidencia EXACTA
        Dim codigoExistente As String = BuscarCodigoPorIdentificacionExacta(pasaporteIngresado)

        ' Si ya existe un registro con este pasaporte exacto y es diferente al actual
        If Not String.IsNullOrEmpty(codigoExistente) AndAlso codigoExistente <> Codigo.Text Then
            Dim resultado As DialogResult = MessageBox.Show(
                "Ya existe un registro con el pasaporte '" & pasaporteIngresado & "'" & vbCrLf &
                "Código: " & codigoExistente & vbCrLf & vbCrLf &
                "¿Desea cargar los datos del registro existente?" & vbCrLf &
                "Sí = Cargar datos existentes" & vbCrLf &
                "No = Continuar con nuevo registro",
                "Pasaporte Duplicado",
                MessageBoxButtons.YesNo,
                MessageBoxIcon.Question)
            ...
            If resultado = DialogResult.Yes Then
                ...
                e.Cancel = True
            Else
                ' Generar un código diferente para el nuevo registro
                Dim contador As Integer = 1
                Dim codigoBase As String = "P" & pasaporteIngresado

                ' Limitar longitud máxima
                If codigoBase.Length > 10 Then
                    codigoBase = codigoBase.Substring(0, 10)
                End If

                Codigo.Text = codigoBase
                While CodigoExiste(Codigo.Text)
                    Codigo.Text = codigoBase & contador.ToString()
                    contador += 1
                    If contador > 99 Then Exit While
                End While
            End If

            ultimoPasaporteValidado = pasaporteIngresado
        End If
    End Sub
