...
Public Class DEEPCNTE
    ...
    Private Sub LlenarCombos()
        ...
        dc.DaxCombosSuc(datosEmpresa.Emp_codigo.ToString(), False, datosEmpresa.strConxDaxsys, cmbSucursalRol, False)
    ...
    Private Sub Apellidos_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Apellidos.TextChanged
        ...
        Dim dt As DataTable = SysEmpDatt.datosEmpresa.leeParametrosEmp("par_acumhis")
        Try
    ...
    Private Sub DEEPCNTE_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Function validacionDatos() As Boolean
        ...
        If SysEmpDatt.datosEmpresa.LongCodDirectorio > 0 And Codigo.Text.Length <> SysEmpDatt.datosEmpresa.LongCodDirectorio Then MsgBox("El código debe tener la longitud correcta (" + SysEmpDatt.datosEmpresa.LongCodDirectorio.ToString() + ")", MsgBoxStyle.Critical) : Return resp
        ...
        If ValidaNumeroId() = False Then
            ...
            Return resp
        End If
        If (txtHistoriaclinica.Text.Length > Codigo.Text.Length) Then Codigo.Text = txtHistoriaclinica.Text
    ...
    Private Sub CargarConceptos(ByVal QueCodigo As String)
        ...
        Dim retn As New RetNombre.AdcNomb
        Dim i As Int32
        Try
    ...
    Private Sub DEEPCNTE_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#End Region
    ...
    Private Sub DEEPCNTE_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
