    ...
    public partial class CtasBanForm : Form
    {
        ...
        public void consultarBancos()
        {
            try
            {
                ...
                combo.DaxCombosBancos(DattCom.datosEmpresa.strConxAdcom, ref bancocomboBox);//conectarAdcom.ConnectionString
            }
            catch { }
        }
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            abreviaturaBanco = Convert.ToString(buscar.Buscar(DattCom.datosEmpresa.strConxAdcom, consulta, "Bco_Codigo", "Bco_Nombre", "", "BusquedaCuentasBancarias"));//
            mostrarDatos();
        ...
        private void guardartoolStripButton_Click(object sender, EventArgs e)
        {
            ...
            if (existeAbreviatura() != 0)
            {
                ...
                + Cta_Codigo + "', Bco_Codigo = '" + Bco_Codigo + "', Bco_Nombre = '" + Bco_Nombre + "', Bco_CodAlex = '" + bancocomboBox.SelectedValue + "'  where Bco_Codigo = '" + abreviaturaBanco.Trim() + "' ";
                    DattCom.SqlDatos.ejecutarComandoAdcom(actualizar);
            ...
            else
            {
                try
                {
                    ...
                    DattCom.SqlDatos.ejecutarComandoAdcom(insertar);
                    modoInicial();
                }
                catch (Exception ee)
                {
        ...
        private void eliminartoolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DattCom.SqlDatos.ejecutarComandoAdcom(eliminar);
                modoInicial();
            }
            catch
            {
        ...
        private void buscarCtaContable_Click(object sender, EventArgs e)
        {
            String nombre = "";
            String var = "S";
            CtaMtn.BuscaCta busca = new CtaMtn.BuscaCta();
            String codigo = busca.BuscaCtaCtb(ref nombre, ref var);
            ctatextBox.Text = codigo;
        }

        private void abrevtextBox_Validating(object sender, EventArgs e)
        {
