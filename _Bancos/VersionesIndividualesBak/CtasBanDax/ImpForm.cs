...
namespace DaxBan
{
    internal partial class ImpForm : Form
    {
            ...
            private void reporte()
            {
                ...
                ReportParameter Empresa = new ReportParameter("Empresa", SysEmpDatt.datosEmpresa.Emp_Nombre);
                rds.Name = "DataSetCtas";
                rds.Value = SysEmpDatt.SqlDatos.leerTablaAdcom(consulta);
                mostrarreportViewer.LocalReport.DataSources.Clear();
                mostrarreportViewer.LocalReport.DataSources.Add(rds);
                this.mostrarreportViewer.LocalReport.ReportPath = SysEmpDatt.datosEmpresa.pathAppl + "BinNet\\Rep\\CtasBco.rdlc";
