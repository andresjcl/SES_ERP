...
//        Boolean Act1 = false;
        ...
        public Form2(string strConxA, double IdClaveDocC, string Documento, long numero, double Adicional = 0, string fecha = "01/01/1900", string Dedonde = "", Int32 Posicion = 0, string DocSuc = "")
        {
            InitializeComponent();
                DeDondeEs = Dedonde;
                FechaHasta = fecha;
        ...
        private void llenarmalla()
        {
            ...
            {
                SalirSN = false;
                MessageBox.Show ( "El Documento no tiene aplicaciones registradas","Consulta aplicaciones");
                return;
            }
